...
const Privacybeleid: React.FC = () => {
  return (
    <>
      <PageSEO
        title="Privacybeleid"
        description="Privacybeleid van Huurly. Lees hoe wij omgaan met uw persoonsgegevens en wat uw rechten zijn volgens de AVG."
        canonical="https://huurly.nl/privacybeleid"
      />
